...
import (
	...
	vs "github.com/voxgig-sdk/dictum-sdk/go/utility/struct"
)

type DictumSDK struct {
	Mode     string
...
func (sdk *DictumSDK) OptionsMap() map[string]any {
...
func (sdk *DictumSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *DictumSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *DictumSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DictumSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *DictumSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *DictumSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("DictumSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *DictumSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DictumSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("DictumSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
