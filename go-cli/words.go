...
func registerSDKWords(r *eng.Registry, client *sdk.DictumSDK) {
...
func runOp(client *sdk.DictumSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
