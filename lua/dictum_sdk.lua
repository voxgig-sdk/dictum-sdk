...
DictumSDK._make_feature = _make_feature


function DictumSDK.new(options)
  local self = setmetatable({}, DictumSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function DictumSDK:options_map()
...
function DictumSDK:get_utility()
  return Utility.copy(self._utility)
end


function DictumSDK:get_root_ctx()
  return self._rootctx
end


function DictumSDK:prepare(fetchargs)
...
function DictumSDK:direct(fetchargs)
...
-- by passing it.
function DictumSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function DictumSDK:graphql(query, variables, ctrl)
...
function DictumSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = DictumSDK.new(sdkopts)
  sdk.mode = "test"
