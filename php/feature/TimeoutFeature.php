...
class DictumTimeoutFeature extends DictumBaseFeature
{
    ...
    private function _with_timeout(DictumContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DictumContext $_ctx, float $ms): void
    {
        $client = $this->client;
