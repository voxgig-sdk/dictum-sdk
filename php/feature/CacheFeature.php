...
class DictumCacheFeature extends DictumBaseFeature
{
    ...
    private function _through(DictumContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
