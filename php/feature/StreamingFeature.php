...
class DictumStreamingFeature extends DictumBaseFeature
{
    ...
    private function _iterate(DictumResult $result): \Generator
    {
    ...
    private function _streamable(DictumContext $ctx): bool
    {
