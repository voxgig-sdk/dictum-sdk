...
class DictumTestRunner
{
    ...
    {
        $live = self::getenv('DICTUM_TEST_LIVE');
        $override = self::getenv('DICTUM_TEST_OVERRIDE');
        ...
        $explain = self::getenv('DICTUM_TEST_EXPLAIN');
...
class_alias('DictumTestRunner', 'Runner');
class_alias('DictumHelpers', 'Helpers');
