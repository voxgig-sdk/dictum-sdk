...
// Dictum SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DictumSDK::test)
...
{
    private const SDK_CLASS = 'DictumSDK';
    ...
    private const SDK_BASE = 'dictum_sdk';
