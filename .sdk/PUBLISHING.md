...
|---|---|---|
| `ts/` | @voxgig-sdk/dictum-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/dictum-sdk \
      --repository voxgig-sdk/dictum-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/dictum-sdk` shows it, and
`npm trust revoke @voxgig-sdk/dictum-sdk --id=<id>` removes it.
