...
class DictumRatelimitFeature extends DictumBaseFeature
{
    ...
    private function _acquire(DictumContext $ctx): void
    {
    ...
    private function _track(DictumContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
