...
class DictumRbacFeature extends DictumBaseFeature
{
    ...
    private function _required(DictumContext $ctx): ?string
    {
    ...
    private function _reject(DictumContext $ctx, string $required): void
    {
    ...
    private function _track(DictumContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
