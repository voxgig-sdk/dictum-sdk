...
// Dictum SDK clienttrack feature
...
class DictumClienttrackFeature extends DictumBaseFeature
{
    ...
    public function PostConstruct(DictumContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Dictum-SDK';
