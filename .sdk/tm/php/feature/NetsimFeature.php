...
class DictumNetsimFeature extends DictumBaseFeature
{
    ...
    private function _simulate(DictumContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(DictumContext $ctx, array $applied): void
    {
        $client = $this->client;
