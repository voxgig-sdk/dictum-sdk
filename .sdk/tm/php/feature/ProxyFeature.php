...
class DictumProxyFeature extends DictumBaseFeature
{
    ...
    public function init(DictumContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DictumContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
