...
// Dictum SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class DictumTestFeature extends DictumBaseFeature
{
    ...
    public function init(DictumContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (DictumContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (DictumContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(DictumContext $ctx, $op, $args): array
    {
