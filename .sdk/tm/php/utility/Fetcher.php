...
class DictumFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DictumSDK/1.0)';
    ...
    public static function call(DictumContext $ctx, string $fullurl, array $fetchdef): array
    {
