...
// Dictum SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class DictumMakeRequest
{
    public static function call(DictumContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new DictumResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new DictumResponse($fetched);
        } else {
