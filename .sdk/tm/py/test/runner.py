...
class DictumTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DictumTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = DictumTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = DictumTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
