...
class DictumTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DictumTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = DictumTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = DictumTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
