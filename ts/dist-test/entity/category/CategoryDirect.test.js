...
function liveScenariosActive() { return false && process.env.DICTUM_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.DictumSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['DICTUM_TEST_CATEGORY_ENTID'];
    ...
    const client = new __1.DictumSDK({
        base: 'http://localhost:8080',
