...
The Python SDK for the Dictum API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/dictum-sdk/releases)) or
...
The main module (`dictum_sdk`) exports the SDK class.
