...
from dictum_sdk.utility.voxgig_struct import voxgig_struct as vs
from dictum_sdk import DictumSDK
from dictum_sdk.core.spec import DictumSpec
from dictum_sdk.core.result import DictumResult
from dictum_sdk.core.response import DictumResponse
from dictum_sdk.core.operation import DictumOperation
from dictum_sdk.core.error import DictumError
from dictum_sdk.core import helpers
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = DictumSDK.test(None, None)
        ...
        class TestInitFeature(DictumBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(DictumBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = DictumSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = DictumSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = DictumSDK.test(None, setup_opts)
