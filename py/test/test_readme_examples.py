# Dictum SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DictumSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DictumSDK(...) and DictumSDK.test(...) become
#      DictumSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "dictum_sdk"
_SDK_CLASS = "DictumSDK"
