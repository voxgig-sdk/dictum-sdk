...
from dictum_sdk.core.control import DictumControl
...
from dictum_sdk.core.helpers import get_ctx_prop, to_map
...
class DictumContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, DictumResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return DictumError(code, msg, self)
