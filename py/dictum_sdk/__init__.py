...
from dictum_sdk.utility import register

# Load features
from dictum_sdk.feature.base_feature import DictumBaseFeature
from dictum_sdk.features import _has_feature, _make_feature
...
class DictumSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = DictumUtility()
        self._utility = utility

        from dictum_sdk.config import shared_config
    ...
    def get_utility(self):
        return DictumUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("DictumSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Author(self, data=None) -> "AuthorEntity":
        ...
        from dictum_sdk.entity.author_entity import AuthorEntity
