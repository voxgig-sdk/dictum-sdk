...
This API provides access to a collection of inspiring expressions gathered throughout history.

Learn more about Dictum API at [www.quoterism.com/developer](https://www.quoterism.com/developer).
...
This SDK exposes the API as a small set of **semantic entities** — Author, Category and Quote — that you
