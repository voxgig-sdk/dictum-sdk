...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/dictum` | `npm install @voxgig-sdk/dictum` |
| Python | `voxgig-sdk-dictum` | `pip install voxgig-sdk-dictum` |
| PHP | `voxgig-sdk/dictum` | `composer require voxgig-sdk/dictum` |
| Golang | `github.com/voxgig-sdk/dictum-sdk/go` | `go get github.com/voxgig-sdk/dictum-sdk/go` |
| Ruby | `voxgig-sdk-dictum` | `gem install voxgig-sdk-dictum` |
| Lua | `voxgig-sdk-dictum` | `luarocks install voxgig-sdk-dictum` |
