...
type Args struct {
	Entity string         `json:"entity" jsonschema:"author | category | quote"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.DictumSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "dictum_list",
		Description: "List records from Dictum. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "dictum_load",
		Description: "Load a single record from Dictum. " +
...
func runOp(client *sdk.DictumSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.DictumSDK, name string) (sdk.DictumEntity, error) {
