...
module DictumTestRunner
  ...
  def self.env_override(m)
    live = getenv("DICTUM_TEST_LIVE")
    override = getenv("DICTUM_TEST_OVERRIDE")
    ...
    explain = getenv("DICTUM_TEST_EXPLAIN")
    m["DICTUM_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = DictumTestRunner
Helpers = DictumHelpers
Vs = VoxgigStruct
