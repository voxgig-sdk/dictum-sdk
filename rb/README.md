...
The Ruby SDK for the Dictum API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `DictumError` (a `StandardError` subclass), so wrap
